...
horas_juego = pd.read_csv("horas_genero.csv")
u_h = pd.read_csv("horas_usuario.csv")
games = pd.read_csv("juegos_limpios.csv")
user_game_matrix = pd.read_csv("Matriz_Usuarios_Juegos.csv")
user = pd.read_csv("usuarios_juegos.csv")
item_game_matrix = pd.read_csv("matriz_datos_juegos.csv")
...
def recomendacionitemitem(nombre_juego: str):
    ...
    juego = juego[0]
    loaded_item_similarity = np.load('item_similarity.npy')
